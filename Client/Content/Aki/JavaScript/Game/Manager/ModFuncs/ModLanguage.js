...
class ModLanguage {
  ...
  static translate = [
    ...
    {
      Text: "Auto_Talk[LeftBracket]",
      chs: "自动对话 [左括号]",
      en: "Auto_Talk[LeftBracket]",
      es: "Auto_Talk[LeftBracket]",
      id: "Auto_Talk[LeftBracket]",
      ja: "Auto_Talk[LeftBracket]",
      ko: "Auto_Talk[LeftBracket]",
      vi: "Auto_Talk[LeftBracket]",
    },
      {
      Text: "Jin_xi_E3[z]",
      chs: "今夕E3 [z]",
