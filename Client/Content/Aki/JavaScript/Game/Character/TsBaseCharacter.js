...
const UE = require ( "ue" ) ,MathUtils_1 = require ( "../../Core/Utils/MathUtils" ) ,
...
class TsBaseCharacter extends UE.BaseCharacter {
    constructor () {
        super ( ... arguments ), this.CharRenderingComponent = void 0, this.RenderType = 0, this.TsCharacterDebugComponent = void 0, this.NavigationInvoker = void 0, this.InputComponentClass = void 0, this.BasePlatform = void 0, this.EntityId = 0, this.FightManager = void 0, this.DtHitEffect = void 0, this.DtBaseMovementSetting = void 0, this.DtNewBulletDataMain = void 0, this.DtCharacterPart = void 0, this.DtCameraConfig = void 0, this.BattleSockets = void 0, this.NormalSockets = void 0, this.WeaponInEffect = void 0, this.WeaponHideEffect = void 0, this.FkData = void 0, this.CharacterData = void 0, this.Camp = 0, this.PhysicsClothSimulateEnable = ! 0, this.PhysicsClothSimulateDisableOneFrame = ! 1, this.CachePoseEnableOneFrame = ! 1, this.CacheTime = .6, this.CharacterActorComponent = void 0, this.SimpleNpcActorComponent = void 0, this.DitherEffectControllerInternal = void 0
    }
    ...
    SetDitherEffect ( e ,t = 3 ) {
         if (ModManager_1.ModManager.Settings.AntiDither){
            this.HasDitherEffectController && this.DitherEffectController?.SetDitherEffect ( 1 ,t )
        }
       else {
